...
int TimeIntervalCompare(TimeInterval *ti1, TimeInterval *ti2) {
  if (DateTimeCompare(ti1->end,ti2->start) == -1)
  {
    return -1;
  }else if (DateTimeCompare(ti1->start,ti2->start)==1)
  {
    return 1;
  }else if (TimeIntervalOverlaps(ti1,ti2))
  {
    return 0;
  }
  return 0;
...
int TimeIntervalContains(TimeInterval *ti1, TimeInterval *ti2) {
  ...
  if (DateTimeCompare(ti1->start,ti2->start)==-1 && DateTimeCompare(ti1->end,ti2->end)==1)
  {
    return 1;
  }else
  {
